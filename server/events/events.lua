...
--]]
RegisterNetEvent('rsg-inventory:server:updateHotbar', function(identifier, itemName)
    ...
    for slot = 1, 5 do
		...
		if itemName and hotbarItem and hotbarItem.name and hotbarItem.name:lower() == itemName:lower() then
            shouldUpdate = true
        end		
    end
